...
<body class="contactBody">
	...
	<div class="header">
		<div class="header1">
			<div class="logo">
				<a href="http://http://localhost:8080/MyKcalCounter/Login.jsp"><img src="images/logo1.png" alt="logo-1"></a>
			</div>
			<!--  
	 ...
	 <div class="link"><a href="Registrazione.jsp">Registrati</a></div> -->
		...
		<div class="header2">
			<ul class="nav site-nav">
				...
				<li><a href="http://localhost:8080/MyKcalCounter/Login.jsp">Diario</a> <!-- * -->
				<li><a href="#">grafici</a> <!-- * -->
				<li><a href="http://localhost:8080/MyKcalCounter/Login.jsp">Impostazioni</a> <!-- * -->
