...
<li><a href="#">Come Personalizzare<br><br> la Mia Dieta</a></li><!-- * -->
 ...
 <div class="wrapper">
        ...
        <input type="text" class="name entry " id="usnm" name="usnm"> 
        <label for="pssw">Password:</label> 
        <input type="password"  class="name entry " id="pssw" name="pssw"> <br> <br>
		<fieldset>
		<legend>Dati personali</legend>
		<label for="pesoAtt">Peso attuale:</label> 
		<input type="number" class="name entry " id="pesoAtt" name="pesoAtt"> <br> <br> 
		<label for="obiettivo">Obiettivo:</label> 
		<input type="number" class="name entry "  id="obiettivo" name="obiettivo"> <br> <br>
		<label for="altezza">Altezza (cm):</label>
        <input type="number" class="name entry "  id="altezza" name="altezza"><br><br>
